    ...
    <div>
      ...
      {atribuicoes.length === 0 ? (
        <EmptyState
          ...
          description="Assim que a Secretaria confirmar sua atribuição no SIGEduc, as avaliações das suas turmas aparecerão aqui."
        />
      ) : avaliacoes.length === 0 ? (
        <EmptyState
          className="mt-8"
          ...
          description="Nenhuma avaliação com resultado registrado em suas turmas ainda."
        />
      ) : (
